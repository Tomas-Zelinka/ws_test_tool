...
import cz.vutbr.fit.dp.xzelin15.modalWindows.NewTestCaseDialog;
import cz.vutbr.fit.dp.xzelin15.modalWindows.NewTestSuiteDialog;
...
public class Menu extends JMenuBar {
	 ...
	 * 
	 */
	private void  initConsoleMenuItems(){
		
		addMenuItem(console,"Debug",new DebugConsoleListener());
		addMenuItem(console,"Normal",new NormalConsoleListener());
	 ...
	 *
	 */
	public class DebugConsoleListener implements ActionListener{
		
		public void actionPerformed(ActionEvent ae) {
			
			ConsoleLog.setConsoleLog(true);
			getMainWindowInstance().clearConsole();
		}
	}
	 ...
	 *
	 */
	public class NormalConsoleListener implements ActionListener{
